              ...
              <div className="card-body py-0 px-0 px-sm-3">
                <div className="row align-items-center">
                  ...
                  <div className="col-5 col-sm-7 col-xl-8 p-0">
                    <h4 className="mb-1 mb-sm-0">Manage your YourOwn</h4>
                    <p className="mb-0 font-weight-normal d-none d-sm-block">Admin can manage YourOwn webpage from here.!</p>
                  </div>
          ...
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">Sales</h6>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
