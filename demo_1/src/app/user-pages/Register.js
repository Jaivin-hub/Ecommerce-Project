          ...
          <div className="row w-100 mx-0">
            <div className="col-lg-4 mx-auto">
              ...
              <div className="card text-left py-5 px-4 px-sm-5">
                <h2>YourOwn</h2>
                <h4>New here?</h4>
                <h6 className="pt-4 font-weight-light">Signing up is easy. It only takes a few steps</h6>
                <form className="pt-3">
                  ...
                  <div className="form-group">
                    <input type="text" className="form-control form-control-lg" id="exampleInputEmail1" placeholder="Phone" />
                  </div>
                  {/* <div className="form-group">
